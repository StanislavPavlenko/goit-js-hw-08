...
formElement.addEventListener("input", (0, _lodashThrottleDefault.default)(onInput, 500));
formElement.addEventListener("submit", onSubmit);
if (tempFormData) {
    if (!tempFormData.email) formElement[0].value = "";
    else formElement[0].value = tempFormData.email;
    if (!tempFormData.message) formElement[1].value = "";
    else formElement[1].value = tempFormData.message;
}
function onInput(e) {
    e.preventDefault();
    let formData = {};
